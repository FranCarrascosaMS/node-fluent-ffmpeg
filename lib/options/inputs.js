...
module.exports = function(proto) {
   ...
   * Set input duration
   *
   * @method FfmpegCommand#inputDuration
   * @category Input
   * @aliases withInputDuration,setInputDuration
   *
   * @param {String|Number} duration duration in seconds or as a '[[hh:]mm:]ss[.xxx]' string
   * @return FfmpegCommand
   */
  proto.withInputDuration =
  proto.setInputDuration =
  proto.inputDuration = function(duration) {
    if (!this._currentInput) {
      throw new Error('No input specified');
    }
